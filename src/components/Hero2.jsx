    ...
    <div className="py-20 2xl:px-0 lg:px-12 px-4 2xl:mx-auto 2xl:container bg-blue-100 rounded-xl">
      <div className="md:flex items-center justify-between w-full bg-blue-100 ">
        <div className="xl:w-1/3 md:w-1/2 w-full">
          ...
          >
            Travel<span className="font-normal italic"> Diaries </span>
          </h1>
          <p
            role="contentinfo"
            className="focus:outline-none text-base text-justify lg:text-left leading-6 mt-8 text-gray-600 2xl:pr-24 xl:pr-0 "
          >
            Our Travel website connects travelers with local hosts who offer
            comfortable and authentic places options. Visitors can choose
